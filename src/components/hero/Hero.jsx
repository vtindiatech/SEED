    ...
    const navigation = [
        ...
        },
        {
            ...
            submenu: [
                ...
                { title: "Women Empowerment", path: "/programs/women-empowerment" },
                { title: "Skill Development", path: "/programs/skill-development" },
                { title: "Cultural Programs", path: "/programs/cultural" },
                { title: "Education for SC/ST Girls", path: "/programs/education-scst" },
                { title: "Environment Awareness", path: "/programs/environment" },
                { title: "Sports Development", path: "/programs/sports" },
                { title: "Health Camps", path: "/programs/health-camps" },
            ]
        },
        {
                                    ...
                                    {navigation.map((item, idx) => (
                                        <li key={idx} className="relative group">
                                            {item.submenu ? (
                                                <>
                                                    <button
                                                        className="block font-medium text-gray-700 hover:text-gray-900 hover:border-b-2 hover:border-blue-600 md:px-2"
                                                    >
                                                        {item.title}
                                                    </button>
                                                    <ul className="absolute left-0 mt-2 w-56 bg-white border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200 z-50">
                                ...
                                <ul className="flex-1 justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                    {navigation.map((item, idx) => (
                                        <li key={idx} className="relative group text-gray-700">
                                            ...
                                            {item.submenu && (
                                                <ul className="absolute left-0 top-full mt-0 w-56 bg-white rounded shadow-lg hidden group-hover:block z-50">
